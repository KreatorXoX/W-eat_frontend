      ...
      <div className="mt-10 flex flex-col gap-4">
        <div className="rounded-lg border p-4">
          ...
          <textarea
            ...
            disabled
            readOnly
            className="w-full rounded-lg bg-gray-200 px-2 py-2 text-gray-700
            outline-none dark:bg-gray-400 dark:text-slate-900
            "
          ></textarea>
          ...
          <Link
            ...
            className="rounded-lg bg-orange-500 px-4 py-[0.15rem] text-slate-200"
          >
            Add / Edit
          </Link>
        </div>
