...
const Account = (props: Props) => {
  ...
  return (
    <div className=" flex h-full flex-col justify-between overflow-y-hidden px-4 text-gray-700 dark:text-slate-100">
      ...
      {token && (
        <div
          onClick={logOut}
          className="flex w-full cursor-pointer items-center justify-center gap-2 border-t border-indigo-400 pt-5 pb-5 lg:pb-0"
        >
